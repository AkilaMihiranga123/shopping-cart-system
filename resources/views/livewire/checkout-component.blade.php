                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="add1" value="" placeholder="Street at apartment number line 1" wire:model="line1">
                                    @error('line1')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </p>
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="add2" value="" placeholder="Street at apartment number line 2" wire:model="line2">
                                </p>
                                <p class="row-in-form">
                        ...
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        <label for="add">Address Line 1:</label>
                                        <input type="text" name="add1" value="" placeholder="Street at apartment number line 1" wire:model="s_line1">
                                        @error('s_line1')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </p>
                                    <p class="row-in-form">
                                        <label for="add">Address Line 2:</label>
                                        <input type="text" name="add2" value="" placeholder="Street at apartment number line 2" wire:model="s_line2">
                                    </p>
                                    <p class="row-in-form">
                                        <label for="country">Country<span>*</span></label>
