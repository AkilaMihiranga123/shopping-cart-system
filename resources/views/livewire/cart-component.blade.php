                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        @if(Session::has('coupon'))
                            <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}})<a herf="#" wire:click.prevent = "removeCoupon"><i class="fa fa-times text-danger"></i> </a></span></span><b class="index"> -${{number_format($discount,2)}}</b></p>
