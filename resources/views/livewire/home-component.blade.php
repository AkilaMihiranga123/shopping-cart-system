                    ...
                    @foreach($sproducts as $sproduct)
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="{{route('product.detail',['slug'=>$sproduct->slug])}}" title="{{$sproduct->name}}">
                            ...
                            <div class="product-info">
                                <a href="{{route('product.detail',['slug'=>$sproduct->slug])}}" class="product-name"><span>{{$sproduct->name}}</span></a>
                                <div class="wrap-price"><ins><p class="product-price">{{$sproduct->sale_price}}</p></ins><del class="product-price">{{$sproduct->regular_price}}</del></div>
                            </div>
                        </div>
                    @endforeach
                </div>
                                    ...
                                    @endphp
                                        @foreach($c_products as $c_product)
                                            <div class="product product-style-2 equal-elem ">
                                                ...
                                                <div class="product-info">
                                                    <a href="{{route('product.detail',['slug'=>$c_product->slug])}}" class="product-name"><span>{{$c_product->name}}</span></a>
